...
import com.scut.loadbalancer.impl.ConsistentHashLoadBalancer;
import com.scut.loadbalancer.impl.RandomLoadBalancer;
...
//    final LoadBalancer loadBalancer = new ConsistentHashLoadBalancer(); //一致性哈希
    final LoadBalancer loadBalancer = new RandomLoadBalancer(); //随机

    @Test
    public void select() {
        // 请求参数
        Map<String, Object> requestParams = new HashMap<>();
        requestParams.put("methodName", "lzl");
        // 服务列表
        ...
        serviceMetaInfo2.setServiceHost("scut.lzl");
